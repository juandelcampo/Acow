    ...
    <main>
        ...
        <header class="nav-menu">
            ...
            <ul id="menu-topo" class= "pt-8">
                ...
                <li >•</li>
                <li class="nav-item"><a href="href="{{ route('login') }}">About</a></li>
                <li >•</li>
                <li class="nav-item"><a href="{{ route('register') }}">API</a></li>
                <li >•</li>
                <li class="nav-item"><a href="{{ route('register') }}">List of Authors</a></li>
            </ul>
        ...
        <section >
            <div object-position: top class="min-w-screen2  pt-8 flex py-w items-center content-center justify-center ">
                <div  style="" >
                    <img src="images/logo.png"  alt="Logo ACOW"  width = '200' heigth = '200' class="center">
                        <div>
