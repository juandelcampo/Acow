                ...
                <tbody class="text-center">
                    ...
                    <tr class="border-b ">
                        ...
                        <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                           <!-- Edit -->
                           <a type="submit" class="inline-flex text-center items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150 btn-edit" href="{{ route('categories.edit',[$category->id]) }}">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-center background-color:red" viewBox="0 0 20 20" fill="currentColor">
                                    <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z" />
                                </svg>
                            </a>
                            <!-- Delete -->
                            <a type="submit" class="inline-flex content-center items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150 btn-delete" href="{{ route('categories.delete',[$category->id]) }}">
