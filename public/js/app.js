...
class GlowParticle {
  ...
  animate ( ctx , stageWidth , stageHeight ) {
    ...
    this.radius += Maath.sin(this.sinValue);
    ...
    g.addColorStop(0,`_rgba(${this.rgb.r}, ${this.rgb.g}, ${this.rgb.b}, 1)`);
    g.addColorStop(1,`_rgba(${this.rgb.r}, ${this.rgb.g}, ${this.rgb.b}, 1)`);
    ctx.fillStyle = g;
    ...
    constructor ( ) {
      ...
      this.ctx = this.canvas.getContext ( ' 2d ' ) ;
       ...
       this.minRadius = 400 ;
        ...
        animate(){
            window.requestAnimationFrame(this.animate.bind.apply(this));

            this.ctx.clearRect(0, 0, this, this.stageWidth, this.stageHeight);
